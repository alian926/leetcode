...
TopVotedCandidate.prototype.q = function (t) {
    const len = this.searchIndex(t);
    if (this.store.has(len)) {
        return this.store.get(len);
    }
    let map = new Map();
    let max = {
        n: null,
...
TopVotedCandidate.prototype.searchIndex = function (t) {
    let ans = null;
 ...
 */
TopVotedCandidate.prototype.q = function (t) {
    const i = this.searchIndex(t);
    return this.store.get(this.times[i]);
};
...
TopVotedCandidate.prototype.setStore = function () {
    ...
    for (let i = 0; i < len; i++) {
        ...
        this.store.set(this.times[i], max.n);
    }
    return max.n;
};
